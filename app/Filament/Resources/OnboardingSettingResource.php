...
use App\Filament\Resources\OnboardingSettingResource\Pages;
...
class OnboardingSettingResource extends Resource
{
    use Translatable;

    protected static ?string $model          = OnboardingSetting::class;
                    ...
                    Forms\Components\Tabs\Tab::make('Content')
                        ...
                        ->schema([
                            Forms\Components\TextInput::make('banner_title')
                                ...
                                ->maxLength(255)
                                ->columnSpanFull(),
                            static::imageUpload('banner_image', 'Banner Background Image', 'onboarding/banner')
                                ->columnSpanFull(),
                            Forms\Components\TextInput::make('subheading')
                                ->label('Subheading (e.g. STORIES)')
                                ->required()
                                ->maxLength(255)
                                ->columnSpanFull(),
                    ...
                    Forms\Components\Tabs\Tab::make('SEO')
                        ...
                        ->schema([
                            ...
                            Forms\Components\TextInput::make('seo_keywords')
                                ...
                                ->maxLength(500)
                                ->columnSpanFull(),
                            static::imageUpload('seo_og_image', 'OG Image (Open Graph)', 'onboarding/seo')
    ...
    // ─── Table (unused – single record, but required by Resource) ─────────────
    ...
    {
        return [
            'index'  => Pages\ListOnboardingSettings::route('/'),
            'create' => Pages\CreateOnboardingSetting::route('/create'),
            'edit'   => Pages\EditOnboardingSetting::route('/{record}/edit'),
        ];
    }
}
