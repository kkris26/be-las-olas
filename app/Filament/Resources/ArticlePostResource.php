...
use App\Filament\Resources\ArticlePostResource\Pages;
...
class ArticlePostResource extends Resource
{
    use Translatable;

    protected static ?string $model           = ArticlePost::class;
            ...
            Forms\Components\Tabs::make('Sections')
                ...
                ->tabs([
                    ...
                    Forms\Components\Tabs\Tab::make('Media')
                        ...
                        ->schema([
                            static::imageUpload('featured_image_desktop', 'Featured Image (Desktop)', 'articles')
    ...
    {
        return [
            'index'  => Pages\ListArticlePosts::route('/'),
            'create' => Pages\CreateArticlePost::route('/create'),
            'edit'   => Pages\EditArticlePost::route('/{record}/edit'),
        ];
    }
}
