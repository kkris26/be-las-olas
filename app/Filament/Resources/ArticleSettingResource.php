...
use App\Filament\Resources\ArticleSettingResource\Pages;
...
class ArticleSettingResource extends Resource
{
    use Translatable;

    protected static ?string $model          = ArticleSetting::class;
                    ...
                    Forms\Components\Tabs\Tab::make('Content')
                        ...
                        ->schema([
                            Forms\Components\TextInput::make('banner_title')
                                ...
                                ->maxLength(255)
                                ->columnSpanFull(),
                            static::imageUpload('banner_image', 'Banner Background Image', 'articles/banner')
                                ->columnSpanFull(),
                            Forms\Components\TextInput::make('subheading')
                                ->label('Subheading (e.g. TIPS & TRICKS)')
                                ->required()
                                ->maxLength(255)
                                ->columnSpanFull(),
                    ...
                    Forms\Components\Tabs\Tab::make('SEO')
                        ...
                        ->schema([
                            ...
                            Forms\Components\TextInput::make('seo_keywords')
                                ->label('Meta Keywords')
                                ->required()
                                ->helperText('Comma-separated, e.g. articles, career tips')
                                ->maxLength(500)
                                ->columnSpanFull(),
                            static::imageUpload('seo_og_image', 'OG Image (Open Graph)', 'articles/seo')
    ...
    {
        return [
            'index'  => Pages\ListArticleSettings::route('/'),
            'create' => Pages\CreateArticleSetting::route('/create'),
            'edit'   => Pages\EditArticleSetting::route('/{record}/edit'),
        ];
    }
}
