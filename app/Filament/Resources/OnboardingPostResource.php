...
use App\Filament\Resources\OnboardingPostResource\Pages;
...
class OnboardingPostResource extends Resource
{
    use Translatable;

    protected static ?string $model           = OnboardingPost::class;
    protected static ?string $navigationIcon  = 'heroicon-o-academic-cap';
    protected static ?string $navigationLabel = 'Onboarding Posts';
            ...
            Forms\Components\Tabs::make('Sections')
                ...
                ->tabs([
                    ...
                    Forms\Components\Tabs\Tab::make('Content')
                        ...
                        ->schema([
                            ...
                            Forms\Components\RichEditor::make('content')
                                ...
                                ->fileAttachmentsDirectory('content/onboarding')
                                ->toolbarButtons([
                    ...
                    Forms\Components\Tabs\Tab::make('Media')
                        ...
                        ->schema([
                            static::imageUpload('featured_image_desktop', 'Featured Image (Desktop)', 'onboarding')
                            ...
                            Forms\Components\Toggle::make('use_mobile_image')
                                ...
                                ->live()
                                ->columnSpanFull(),
                            static::imageUpload('featured_image_mobile', 'Featured Image (Mobile)', 'onboarding/mobile')
                                ->columnSpanFull()
    ...
    {
        return [
            'index'  => Pages\ListOnboardingPosts::route('/'),
            'create' => Pages\CreateOnboardingPost::route('/create'),
            'edit'   => Pages\EditOnboardingPost::route('/{record}/edit'),
        ];
    }
}
