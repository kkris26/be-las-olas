...
class OnboardingController extends Controller
{
     ...
     */
    private function getFallbackContent(OnboardingPost $post, string $field, string $requestedLang)
    {
    ...
    /**
     * GET /api/onboarding?lang=en|id&page=1&per_page=6
     *
     * Returns paginated list of published onboarding posts (cached 300s).
     */
    public function index(Request $request): JsonResponse
    {
        ...
        // ── Database Query ──────────────────────────────────────────
        $posts = OnboardingPost::whereNotNull('published_at')
    ...
    /**
     * GET /api/onboarding/{slug}?lang=en|id
     *
     * Returns full onboarding post details by slug (cached 300s).
     */
    public function show(string $slug, Request $request): JsonResponse
    {
        ...
        $post = OnboardingPost::whereNotNull('published_at')
        ...
        if (!$post) {
            return response()->json(['message' => 'Onboarding post not found.'], 404);
        }
