...
class OnboardingSettingController extends Controller
{
    private const MODULE = 'onboarding-setting';
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $page = OnboardingSetting::first();

        if (! $page) {
            return response()->json(['message' => 'Onboarding setting not found.'], 404);
        }
